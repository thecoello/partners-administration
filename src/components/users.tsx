...
> {
  ...
  createUser = () => {
    ...
    if(this.state.name && this.state.contact && this.state.email && this.state.password && this.state.userType ){
            ...
            <div className="col">
              <div className="mb-3">
                ...
                >
                  ...
                  <option value="3">
                    Panama (NA + LAC) + Bangkok (APJ + GC) + Vienna (EMEA + MEE)
                  </option>
                </select>
              </div>
            </div>
      ...
      <>
        <div className="section">
          <div id="createAndUpdateUser">
            ...
            >
              <div
                className="offcanvas-header bg-black text-white
"
              >
