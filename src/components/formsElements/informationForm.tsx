                ...
                <div className='row'>
                  <div className='col-12 align-items-center justify-content-center'>
                    <form encType='multipart/form-data' className='needs-validation' onSubmit={this._standInfo ? this.formUpdate.bind(this) : this.formCreate.bind(this)}>
                      ...
                      <div className='mb-3'>
                        <button type='submit' className='btn btn-dark'> Submit booth information </button>
                      </div>
                  ...
                  <div className='col-12 align-items-center justify-content-center'>
                    <form encType='multipart/form-data' className='needs-validation' onSubmit={this._standInfo ? this.formUpdate.bind(this) : this.formCreate.bind(this)}>
                      ...
                      <div className='row border rounded p-4'>
                        ...
                        <div className='mb-3'>
                          <button type='submit' className='btn btn-dark'> Submit event app information </button>
                        </div>
                  ...
                  <div className='col-12 align-items-center justify-content-center'>
                    <form encType='multipart/form-data' className='needs-validation' onSubmit={this._standInfo ? this.formUpdate.bind(this) : this.formCreate.bind(this)}>
                      ...
                      <div className='row border rounded p-4'>
                        ...
                        <div className='mb-3'>
                          <button type='submit' className='btn btn-dark'> Submit Breakout session information </button>
                        </div>
