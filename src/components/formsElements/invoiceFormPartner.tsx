          ...
          <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="col-3">
                ...
                <h5 className="m-1"><b>{invoice.total != null ? null : <Warning />} Total:</b> {invoice.company_name && invoice.address && invoice.zip && invoice.country && invoice.vat ? invoice.total + event.symbol : <p>The total price will be calculated once the tax information has been filled in.</p>}</h5>
              </div>
            </div>
